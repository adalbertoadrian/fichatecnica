<?php
  ...
  // Variables LDAP
  $servidor_ldap = "ldapr7-pzo.corpoelec.com.ve";  // el servidor LDAP al que se quiere conectar
  $puerto_ldap = 389;             // el puerto al que se conectara
  $usr = $_POST['username'];       // el usuario
  $pwr = $_POST['password'];      // la contraseña

  $atributos=array ("uid","mail","cn","maildrop","telephonenumber","employeenumber","userPassword","dn");
  $dn = "ou=USUARIOS,ou=REGION7,o=CORPOELEC,dc=corpoelec,dc=gob,dc=ve";
  $usuario="(uid=".$usr.")";
